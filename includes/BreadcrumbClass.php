				...
				if(is_home())
					{
						...
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" title="Home" href="#">Home</a><span>'.$breadcrumb_separator.'</span></li>';
				...
				else if(is_attachment())
					{
						...
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="Home" href="'.get_bloginfo('url').'">Home</a></li>';
				...
				else if(is_singular())
					{
						...
						if(is_page() && $post->post_parent)
							...
							{
								$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span  class="separator">'.$breadcrumb_separator.'</span><a itemprop="item" title="'.get_the_title().'" href="#">'.get_the_title().'</a><span class="separator">'.$breadcrumb_separator.'</span></li>';
							}
				...
				else if( is_tax())
					{
						...
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="Home" href="'.get_bloginfo('url').'">Home</a></li>';
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span class="separator">'.$breadcrumb_separator.'</span><a itemprop="item" href="#">'.$term_name.'</a><span class="separator">'.$breadcrumb_separator.'</span></li>';
					}
				...
				else if(is_category())
					{
						...
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" title="Home" href="'.get_bloginfo('url').'">Home</a></li>';
						$html .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span class="separator">'.$breadcrumb_separator.'</span>'.$parent_cat_links.'</li>';
					}
				...
				else if(is_tag())
					{
						...
						$html .= '<li itemprop="itemListElement" itemscope><a itemprop="item" title="Home" href="'.get_bloginfo('url').'">Home</a><span class="separator">'.$breadcrumb_separator.'</span></li>';			
						$html .= '<li itemprop="itemListElement" itemscope><a itemprop="item" title="Home" href="'.$current_tag_link.'">'.$current_tag_name.'</a><span class="separator">'.$breadcrumb_separator.'</span></li>';
